            ...
            <Row>
                <Col md={4} style={{display: "flex", justifyContent: "center"}}>
                    <Card
                        ...
                        icon={<img src={anonymousIcon} alt="anonymous" width={40} height={40}/>}
                    />
                </Col>
                <Col md={4} style={{display: "flex", justifyContent: "center"}}>
                    <Card
                        ...
                        icon={<img src={accountableIcon} alt="accountable" width={40} height={40}/>}
                    />
                </Col>
                <Col md={4} style={{display: "flex", justifyContent: "center"}}>
                    <Card
                        ...
                        icon={<img src={encryptedIcon} alt="encrypted" width={40} height={40}/>}
                    />
                </Col>
            </Row>
        </Container>
