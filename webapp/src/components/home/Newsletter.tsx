...
import {Button, Col, Form, FormFeedback, FormGroup, Input, InputGroup} from "reactstrap";
...
const Newsletter: FC = () => {
    ...
    return (
        <div style={{background: "linear-gradient(135deg, #4FABCE, #4347BA)", padding: "80px 40px"}}>
            <h2 style={{textAlign: "center", marginBottom: 20}}>
                Stay updated on the latest FELT news!
            </h2>

            <Col md="6" id="sib-form-container" className="sib-form-container" style={{margin: "auto"}}>
